...
const Carousel3D = ({
  ...
  return _jsx("section", {
    id: "carousel3d",
    className:
      "bg-transparent min-w-full mx-aut \r\n    flex items-center justify-center",
    children: _jsx("div", {
      className:
                          ...
                          _jsxs("div", {
                            ...
                            children: [
                              _jsx("div", {
                                ...
                                children: item.tags.map((tag, idx) =>
                                  _jsx(
                                    "span",
                                    {
                                      className:
                                        "px-2 py-1 bg-gray-50 text-gray-600 rounded-full text-xs animate-pulse-slow",
                                      children: tag,
                                    },
                                    idx
                                  )
                              ...
                              _jsxs("a", {
                                href: item.link,
                                className:
                                  "text-gray-500 flex items-center hover:underline relative group",
                                onClick: () => {
                                ...
                                children: [
                                  ...
                                  _jsx(ArrowRight, {
                                    className:
                                      "ml-2 w-4 h-4 relative z-10 transition-transform group-hover:translate-x-1",
                                  }),
                                  _jsx("span", {
                                    className:
                                      "absolute left-0 bottom-0 w-0 h-0.5 bg-gray-500 transition-all duration-300 group-hover:w-full",
                                  }),
                                ],
                              }),
                            ],
          ...
          !isMobile &&
            _jsxs(_Fragment, {
              children: [
                _jsx("button", {
                  className:
                    "absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/80 rounded-full flex items-center justify-center text-gray-500 hover:bg-white z-30 shadow-md transition-all hover:scale-110",
                  onClick: () =>
                    setActive(
                ...
                _jsx("button", {
                  className:
                    "absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/80 rounded-full flex items-center justify-center text-gray-500 hover:bg-white z-30 shadow-md transition-all hover:scale-110",
